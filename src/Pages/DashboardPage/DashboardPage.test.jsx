...
describe("DashboardPage", () => {
  test("renders Line Chart and Bar Chart buttons in edit mode", () => {
    ...
    // Check if both Line Chart and Bar Chart buttons are rendered
  ...
  test("toggles Line Chart visibility", () => {
    ...
    // Click on Line Chart button to toggle visibility
    fireEvent.click(getByText("Show Line Chart"));

    // Check if the Line Chart button changes to Hide Line Chart
  ...
  test("toggles Bar Chart visibility", () => {
    ...
    // Click on Bar Chart button to toggle visibility
    fireEvent.click(getByText("Show Bar Chart"));

    // Check if the Bar Chart button changes to Hide Bar Chart
